...
public class RestResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleServiceException(final ServiceException ex, final WebRequest request) {
        return ResponseEntity.status(HttpStatus.valueOf(ex.getCode())).body(new ServiceExceptionDTO(HttpStatus.BAD_REQUEST.value(), ex.getMessage()));
    }
    ...
    public ResponseEntity<Object> handleServiceException(final MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ServiceExceptionDTO(HttpStatus.BAD_REQUEST.value(), messages));
    }
}
